...
export default function RecentView() {
  ...
  const rawTabs = useLiveQuery(() => db.tabs.orderBy('lastAccessed').reverse().limit(10).toArray());
  ...
  return (
    <div className="flex flex-col gap-8 pb-12">
      <h1 className="text-2xl font-semibold tracking-tight">Recent Tabs</h1>
      <p className="text-sm text-zinc-500 -mt-6">Showing your 10 most recently accessed tabs.</p>
      ...
      {tabs.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center mt-20 text-center">
          ...
          <h3 className="text-xl font-medium text-zinc-300 mb-2">No recent tabs</h3>
        </div>
      )}
    </div>
  );
